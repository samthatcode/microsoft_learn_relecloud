...
export default {
    name: 'Host', //NOTE - name field sets the name of the component
    data() { //NOTE -  registers the cruise object as data for the component
        return {
            cruise: {
    ...
    // Todo: Registers the imported components here
    components: {
        BookingList,
        BookingForm
